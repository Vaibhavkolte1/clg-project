...
import { FaTrashAlt, FaTag, FaBoxOpen, FaChartLine } from 'react-icons/fa';

const ProductHandleSeller = ({ id, name, image, price, stock, sold }) => {
    ...
    const handleDeletProduct = () => {
        ...
        api.delete('/seller/delete-product', {
            params: {
                productId: id,
            }
...
export default ProductHandleSeller